...
public class UploadUtilities {
     ...
     */
    public static NameValuePair[] getNameValuePairs(String data, String delim1,
                                                    String delim2) {
     ...
     */
    public static Hashtable getNameValuePairHash(String data, String delim1,
                                                 String delim2) {
     ...
     */
    public static String replace(String original, String toReplace,
                                 char[] replaceWith) {
