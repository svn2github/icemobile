;(function () {
    ...
    Tablesort.prototype = {
        ...
        init: function(id, options) {
            ...
            var el = document.querySelector("#" + id + " .mobi-tbl-master table");
            var headersEl = document.querySelector("#" + id + " .mobi-tbl-headers table");

            if (el.rows && el.rows.length > 0) {
                if(headersEl.tHead && headersEl.tHead.rows.length > 0) {
                    firstRow = headersEl.tHead.rows[headersEl.tHead.rows.length - 1];
                    that.thead = true;
                } else {
                    firstRow = headersEl.rows[0];
                }
            }
        ...
        sortTable: function(header, update) {
            ...
            var sortFunction;
            var t = document.querySelector("#" + this.id + " .mobi-tbl-master table");
            var item = '', i = 0;
