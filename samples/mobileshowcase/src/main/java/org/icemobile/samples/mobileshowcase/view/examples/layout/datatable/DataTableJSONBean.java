...
@Destination(
        title = "example.layout.datatable.json.destination.title.short",
        titleExt = "example.layout.datatable.json.destination.title.long",
        titleBack = "example.layout.datatable.json.destination.title.back"
)
@Example(
        descriptionPath = "/WEB-INF/includes/examples/layout/datatable-desc.xhtml",
        examplePath = "/WEB-INF/includes/examples/layout/datatable-json-example.xhtml",
...
@ExampleResources(
        resources = {
                ...
                @ExampleResource(type = ResourceType.xhtml,
                        ...
                        resource = "/WEB-INF/includes/examples/layout/datatable-json-example.xhtml"),
                // Java Source
                @ExampleResource(type = ResourceType.java,
                        title = "DataTableBean.java",
                        resource = "/WEB-INF/classes/org/icemobile/samples/mobileshowcase" +
                                "/view/examples/layout/datatable/DataTableJSONBean.java")
        }
)
@ManagedBean(name = DataTableJSONBean.BEAN_NAME)
@SessionScoped
public class DataTableJSONBean extends ExampleImpl<DataTableJSONBean> implements
    Serializable {
    
    public static final String BEAN_NAME = "dataTableJSONBean";
    
    public DataTableJSONBean() {
        super(DataTableJSONBean.class);
