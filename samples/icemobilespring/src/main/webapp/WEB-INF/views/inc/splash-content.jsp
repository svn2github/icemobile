...
<mobi:fieldSetGroup inset="true">
    <div style="padding:0 20px;">
        ...
        <div style="float:left;width:100%;">
            <img
                    style="float:left;width:125px;height:125px;padding:10px 10px 0 0;"
                    src="./resources/qrcode.png"/>
            <div style="padding-top: 25px;">
                <h3>ICEmobile Spring MVC Component Showcase</h3>
                <h5 style="clear: both;margin-left:0;">ICEsoft Technologies Inc.</h5>
            </div>
        </div>
