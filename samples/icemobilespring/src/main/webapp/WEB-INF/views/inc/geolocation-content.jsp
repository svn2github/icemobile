...
<form:form id="geolocationform" method="POST"
    ...
    <mobi:fieldsetGroup styleClass="intro">
        <mobi:fieldsetRow>
            ...
            Various settings for the geolocation tag can also be adjusted below.
        </mobi:fieldsetRow>
    </mobi:fieldsetGroup>
    ...
    <mobi:fieldsetGroup>
        ...
        <mobi:fieldsetRow>
            ...
            <select name="enableHighPrecision"
                ...
                <option selected="${geolocationBean.enableHighPrecision eq 'asNeeded' ? 'selected' : ''}">asNeeded</option>
            </select>
        </mobi:fieldsetRow>
        <mobi:fieldsetRow>
