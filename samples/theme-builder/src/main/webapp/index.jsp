...
<%@ taglib prefix="mobi" uri="http://www.icemobile.org/tags"  %>
		...
		<div id="wrapper">
			...
			<%
    			if( style != null || styleId != null ) {
    			    out.println("<div style=\"display: none\" id=\"imported-style\">true</div>");
    			}
			%>
			...
			<div id="style"><%
					if( style != null ) {
						...
						String filePath = "jqm/1.2.0/jqm.starter.theme.css";
						if( styleId != null ) {
							filePath = "jqm/1.2.0/user_themes/" + styleId + ".css";
						}
