...
public class UserAgentInfo {
    ...
    public static final String TRANSORMER_PRIME = "transformer prime";
    public static final String DROID2 = "droid2";
   ...
   public boolean isMobileBrowser(){
       return (userAgentString.matches("(?i).*(android.+mobile|droid2|avantgo|bada\\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|lge |maemo|meego.+mobile|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino).*")
               ...
               && !userAgentString.contains(UserAgentInfo.TRANSORMER_PRIME);
   ...
   public boolean isTabletBrowser(){
       return userAgentString.matches("(?i).*(android|ipad|playbook|silk|pocket|psp|gt-p1000|transformer prime).*")
               && !userAgentString.contains(UserAgentInfo.DROID2);
   }
