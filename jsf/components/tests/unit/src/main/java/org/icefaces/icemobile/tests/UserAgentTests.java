...
public class UserAgentTests  {
	...
	public void testUserAgents() throws Exception{
		...
		while( iter.hasNext()){
			...
			if( dt != null && (dt == DeviceType.ANDROID_PHONE || dt == DeviceType.BLACKBERRY || dt == DeviceType.IPHONE)){
				assertTrue("Incorrect match for mobile phone : " + dt + " " + d.userAgent, isMobileBrowser(d.userAgent));
			}
			else if( dt != null && (dt == DeviceType.ANDROID_TABLET || dt == DeviceType.IPAD)){
				assertTrue("Incorrect match for tablet : " + dt + " " + d.userAgent, isTabletBrowser(d.userAgent));
			}
		}
	 ...
	 * @return true if mobile
	 */
	public boolean isTabletBrowser(String userAgent){
		String ua=userAgent.toLowerCase();
